...
/*******************************************************************************************************************//**
 * Get MCU specific FLASH HP features
 * @param[out] p_flash_hp_feature  Pointer to structure to store Flash HP features.
 **********************************************************************************************************************/
void R_BSP_FeatureFlashHpGet(bsp_feature_flash_hp * p_flash_hp_feature);
