...
#endif
static uint8_t new_thread1_stack[1024] BSP_PLACE_IN_SECTION(".stack.new_thread1") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
...
void new_thread1_create(void)
{
    ...
    tx_thread_create (&new_thread1, (CHAR *) "New Thread", new_thread1_func, (ULONG) NULL, &new_thread1_stack, 1024, 1,
                      1, 1, TX_DONT_START);
}
