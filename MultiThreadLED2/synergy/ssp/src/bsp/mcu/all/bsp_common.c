...
static BSP_DONT_REMOVE const ssp_pack_version_t g_ssp_version BSP_PLACE_IN_SECTION(SSP_SECTION_VERSION) =
{
...
static BSP_DONT_REMOVE const uint8_t g_ssp_version_string[] BSP_PLACE_IN_SECTION(SSP_SECTION_VERSION) =
        SSP_VERSION_STRING;

/* Unique SSP version ID. */
/*LDRA_INSPECTED 57 D - This global is being initialized at it's declaration below. */
static BSP_DONT_REMOVE const uint8_t g_ssp_version_build_string[] BSP_PLACE_IN_SECTION(SSP_SECTION_VERSION) =
